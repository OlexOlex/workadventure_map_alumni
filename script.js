...
WA.onEnterZone('jitsi_bookclub', () => { WA.sendChatMessage('Willkommen in der Bibliothek.', 'Schild'); });

WA.onEnterZone('jitsi_smokers', () => { WA.sendChatMessage('Raucherbereich. Bitte die Kippenstummel in den Aschenbecher werfen.'', 'Schild'); });
